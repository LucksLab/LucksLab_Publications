...
% 
    ...
    DATA=[GM_MEAN;GM_UB;GM_LB;Exp_Data_DF.avg;Exp_Data_DF.stdv]; % Saved text files contain mean,lower bound, upper bound and normalized experimenl data.
	filename=['PLOT_NAR_CSTR_',num2str(CSTR_LV),'.txt'];
